...
using Zeta.AgentosCRM.MultiTenancy.HostDashboard;
...
namespace Zeta.AgentosCRM.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(AgentosCRMDbContext context, SubscriptionPayment subscriptionPayment)
        {
