...
namespace Zeta.AgentosCRM.Tests.Authorization.Accounts
{
    ...
    public class Password_Reset_Tests : AppTestBase
    {
        ...
        public async Task Should_Not_Reset_Password_When_ResetCode_Is_Expired()
        {
            ...
            exception.Message.ShouldContain(localizationManager.GetString(AgentosCRMConsts.LocalizationSourceName,
