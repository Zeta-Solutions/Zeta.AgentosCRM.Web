...
namespace Zeta.AgentosCRM.Core.Base
{
    public abstract class AgentosCRMQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected AgentosCRMQueryBase(string fieldName,
