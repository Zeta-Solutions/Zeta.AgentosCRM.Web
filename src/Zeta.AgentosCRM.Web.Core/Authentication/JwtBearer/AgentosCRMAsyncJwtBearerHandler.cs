...
{
    public class AgentosCRMAsyncJwtBearerHandler : AuthenticationHandler<AsyncJwtBearerOptions>
    {
        ...
        /// </summary>
        /// <inheritdoc />
        public AgentosCRMAsyncJwtBearerHandler(IOptionsMonitor<AsyncJwtBearerOptions> options,
