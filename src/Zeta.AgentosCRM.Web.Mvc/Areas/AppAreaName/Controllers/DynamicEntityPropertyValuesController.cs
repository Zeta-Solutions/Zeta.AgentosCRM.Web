...
using Zeta.AgentosCRM.Web.Areas.AppAreaName.Models.DynamicEntityPropertyValues;
...
namespace Zeta.AgentosCRM.Web.Areas.AppAreaName.Controllers
{
    ...
    public class DynamicEntityPropertyValuesController : AgentosCRMControllerBase
    {
