...
using Zeta.AgentosCRM.Web.Areas.AppAreaName.Models.Roles;
using Zeta.AgentosCRM.Web.Areas.AppAreaName.Models.Users;
...
namespace Zeta.AgentosCRM.Web.Areas.AppAreaName.Controllers
{
    [Area("AppAreaName")]
    [AbpMvcAuthorize]
    public class UsersController : AgentosCRMControllerBase
    {
