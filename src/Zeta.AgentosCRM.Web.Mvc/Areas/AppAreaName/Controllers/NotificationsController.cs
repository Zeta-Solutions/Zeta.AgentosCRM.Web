...
using Zeta.AgentosCRM.Organizations;
using Zeta.AgentosCRM.Web.Areas.AppAreaName.Models.Notifications;
using Zeta.AgentosCRM.Web.Areas.AppAreaName.Models.OrganizationUnits;
...
namespace Zeta.AgentosCRM.Web.Areas.AppAreaName.Controllers
{
    [Area("AppAreaName")]
    [AbpMvcAuthorize]
    public class NotificationsController : AgentosCRMControllerBase
    {
