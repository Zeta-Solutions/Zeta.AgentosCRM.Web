...
using Zeta.AgentosCRM.Web.Areas.AppAreaName.Models.Languages;
...
namespace Zeta.AgentosCRM.Web.Areas.AppAreaName.Controllers
{
    ...
    public class LanguagesController : AgentosCRMControllerBase
    {
            ...
            string filterText = "")
        {
            ...
            {
                sourceName = AgentosCRMConsts.LocalizationSourceName;
            }
