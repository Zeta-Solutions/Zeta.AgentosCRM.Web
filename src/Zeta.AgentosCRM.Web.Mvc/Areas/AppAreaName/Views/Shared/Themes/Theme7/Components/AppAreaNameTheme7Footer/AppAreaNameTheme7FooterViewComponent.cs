...
namespace Zeta.AgentosCRM.Web.Areas.AppAreaName.Views.Shared.Themes.Theme7.Components.AppAreaNameTheme7Footer
{
    public class AppAreaNameTheme7FooterViewComponent : AgentosCRMViewComponent
    {
