...
namespace Zeta.AgentosCRM.Web.Areas.AppAreaName.Views.Shared.Themes.Theme11.Components.AppAreaNameTheme11Brand
{
    public class AppAreaNameTheme11BrandViewComponent : AgentosCRMViewComponent
    {
