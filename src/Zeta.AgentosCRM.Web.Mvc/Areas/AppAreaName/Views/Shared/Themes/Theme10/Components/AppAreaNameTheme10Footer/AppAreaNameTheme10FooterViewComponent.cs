...
namespace Zeta.AgentosCRM.Web.Areas.AppAreaName.Views.Shared.Themes.Theme10.Components.AppAreaNameTheme10Footer
{
    public class AppAreaNameTheme10FooterViewComponent : AgentosCRMViewComponent
    {
