...
namespace Zeta.AgentosCRM.Web.Areas.AppAreaName.Views.Shared.Themes.Theme3.Components.AppAreaNameTheme3Brand
{
    public class AppAreaNameTheme3BrandViewComponent : AgentosCRMViewComponent
    {
