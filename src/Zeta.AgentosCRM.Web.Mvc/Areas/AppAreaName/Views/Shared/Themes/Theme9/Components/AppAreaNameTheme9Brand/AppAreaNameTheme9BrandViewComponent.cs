...
namespace Zeta.AgentosCRM.Web.Areas.AppAreaName.Views.Shared.Themes.Theme9.Components.AppAreaNameTheme9Brand
{
    public class AppAreaNameTheme9BrandViewComponent : AgentosCRMViewComponent
    {
