...
namespace Zeta.AgentosCRM.Web.Areas.AppAreaName.Views.Shared.Themes.Theme12.Components.AppAreaNameTheme12Footer
{
    public class AppAreaNameTheme12FooterViewComponent : AgentosCRMViewComponent
    {
