...
namespace Zeta.AgentosCRM.Web.Areas.AppAreaName.Views.Shared.Themes.Theme13.Components.AppAreaNameTheme13Footer
{
    public class AppAreaNameTheme13FooterViewComponent : AgentosCRMViewComponent
    {
