...
namespace Zeta.AgentosCRM.Web.Areas.AppAreaName.Views.Shared.Themes.Theme8.Components.AppAreaNameTheme8Brand
{
    public class AppAreaNameTheme8BrandViewComponent : AgentosCRMViewComponent
    {
