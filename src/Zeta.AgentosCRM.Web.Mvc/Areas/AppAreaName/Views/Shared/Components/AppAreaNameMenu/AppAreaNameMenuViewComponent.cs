...
namespace Zeta.AgentosCRM.Web.Areas.AppAreaName.Views.Shared.Components.AppAreaNameMenu
{
    public class AppAreaNameMenuViewComponent : AgentosCRMViewComponent
    {
