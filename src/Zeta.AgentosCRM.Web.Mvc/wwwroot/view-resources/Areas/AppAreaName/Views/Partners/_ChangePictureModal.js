(function ($) {
    ...
    app.modals.ChangeProfilePictureModal = function () {
        ...
        var _profileService = abp.services.app.partnerProfile;
        ...
        function saveInternal(input) {
            ...
            if (input.PartnerId > 0) {
                _profileService.updateProfilePicture(input).done(function (data) {
                    ...
                    var partnerId = input.PartnerId ?? 0;
                ...
                _profileService.insertProfilePictureForPartner(input).done(function (data) {
                    if ($cropperJsApi) {
                        $cropperJsApi = null;
                    }
                    var partnerId = input.PartnerId ?? 0;
                    ...
                    var imageUrl = $.ajax({
                        url: abp.appPath + 'api/services/app/PartnerProfile/GetProfilePictureByPictireId',
                        data: {
