(function () {
    $(function () {
        var _$SubjectTable = $('#Promotionstable');
        ...
        var _createOrEditModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppAreaName/Partners/CreateOrEditPromotionsModal',
        ...
        abp.event.on('app.createOrEditPromotionsModalSaved', function () {
            getSubjects();
        });
