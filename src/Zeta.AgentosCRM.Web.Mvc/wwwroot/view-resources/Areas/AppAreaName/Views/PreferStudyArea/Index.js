(function () {
    $(function () {
        var _$PreferStudyAreaTable = $('#PreferStudyAreatable');
        ...
        var _createOrEditModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppAreaName/PreferStudyArea/CreateOrEditModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AppAreaName/Views/PreferStudyArea/_CreateOrEditModal.js',
            modalClass: 'CreateOrEditModal',
        });
      
        var _viewPreferStudyAreaModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppAreaName/PreferStudyArea/ViewPreferStudyAreaModal',
            modalClass: 'ViewPreferStudyAreaModal',
        });
        ...
        var dataTable = _$PreferStudyAreaTable.DataTable({
            paging: true,
            serverSide: true,
            processing: true,
            listAction: {
                        ...
                        items: [

                            {
                                ...
                                action: function (data) {
                                    _viewPreferStudyAreaModal.open();
                                },
                            },
                            {
