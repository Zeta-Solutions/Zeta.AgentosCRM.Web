(function ($) {
    ...
    app.modals.ChangeProfilePictureModal = function () {
        ...
        var _profileService = abp.services.app.agentProfile;
        ...
        function saveInternal(input) {
            ...
            if (input.AgentId > 0) {
                ...
                _profileService.insertProfilePictureForAgent(input).done(function (data) {
                    if ($cropperJsApi) {
                        $cropperJsApi = null;
                    }
                    var agentId = input.agentId ?? 0;
                    ...
                    var imageUrl = $.ajax({
                        url: abp.appPath + 'api/services/app/AgentProfile/GetProfilePictureByPictireId',
                        data: {
