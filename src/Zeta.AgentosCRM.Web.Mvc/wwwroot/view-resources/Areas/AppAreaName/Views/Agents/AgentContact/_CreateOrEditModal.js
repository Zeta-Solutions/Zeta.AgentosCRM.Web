(function ($) {
    app.modals.CreateOrEditContactsModal = function () {
        ...
        var _modalManager;
        var _$agentContactsInformationForm = null;
        ...
        this.init = function (modalManager) {
            ...
            _$agentContactsInformationForm = _modalManager.getModal().find('form[name=ContactsInformationsForm]');
            _$agentContactsInformationForm.validate();
        };
        ...
        this.save = function () {
            ...
            if (!_$agentContactsInformationForm.valid()) {
                return;
            }

            var branches = _$agentContactsInformationForm.serializeFormToObject();
