(function () {
  $(function () {
      var _$masterCategoriesTable = $('#PersonalDetailsTable');
    ...
    var _createOrEditModal = new app.ModalManager({
        viewUrl: abp.appPath + 'AppAreaName/PersonalDetails/CreateOrEditModal',
        scriptUrl: abp.appPath + 'view-resources/Areas/AppAreaName/Views/PersonalDetails/_CreateOrEditModal.js',
        modalClass: 'CreateOrEditModal',
    });

    var _viewMasterCategoryModal = new app.ModalManager({
        viewUrl: abp.appPath + 'AppAreaName/PersonalDetails/ViewPersonalDetailsModal',
        modalClass: 'ViewPersonalDetailsModal',
    });
    ...
    $('#HideAdvancedFiltersSpan').click(function () {
      ...
      $('#CreateNewPersonalDetailsButton').click(function () {
      _createOrEditModal.open();
    });
