(function () {
  $(function () {
    ...
    var _createOrEditModal = new app.ModalManager({
      viewUrl: abp.appPath + 'AppAreaName/Source/CreateOrEditModal',
        scriptUrl: abp.appPath + 'view-resources/Areas/AppAreaName/Views/Source/_CreateOrEditModal.js',
        modalClass: 'CreateOrEditModal',
    });

      var _viewSourceModal = new app.ModalManager({
        viewUrl: abp.appPath + 'AppAreaName/Source/ViewSourceModal',
        modalClass: 'ViewSourceModal',
    });
    ...
    var getMaxDateFilter = function (element) {
      ...
      var dataTable = _$SourceTable.DataTable({
      paging: true,
      serverSide: true,
      processing: true,
      listAction: {
