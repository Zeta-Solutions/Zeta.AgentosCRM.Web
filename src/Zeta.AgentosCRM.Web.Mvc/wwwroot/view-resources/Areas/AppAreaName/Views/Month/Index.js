(function () {
  $(function () {
    ...
    var _createOrEditModal = new app.ModalManager({
        viewUrl: abp.appPath + 'AppAreaName/Month/CreateOrEditModal',
        scriptUrl: abp.appPath + 'view-resources/Areas/AppAreaName/Views/Month/_CreateOrEditModal.js',
        modalClass: 'CreateOrEditModal',
    });

    var _viewMasterCategoryModal = new app.ModalManager({
        viewUrl: abp.appPath + 'AppAreaName/Month/ViewMonthModal',
        modalClass: 'ViewMonthModal',
    });
