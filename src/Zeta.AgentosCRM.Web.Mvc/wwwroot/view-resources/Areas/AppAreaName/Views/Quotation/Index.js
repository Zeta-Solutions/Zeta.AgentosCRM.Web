...
(function () {
    $(function () {
        var _$clientQuotationHeadsTable = $('#Quotationtable');
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        // Assuming row.clientId contains the ID you want to hide
                        return `<span class="ClientId"style="display: none;">${row.clientQuotationHead.clientId}</span>${data}`;
                    },
                },
                {
                    targets: 2,
        ...
        var _createOrEditModal = new app.ModalManager({
            ...
            modalClass: 'CreateOrEditClientModal',
        });
        var _createOrEditClientsQuotationModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppAreaName/Quotation/CreateClientQuotationModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AppAreaName/Views/Quotation/_CreateOrEditClientModal.js',
            modalClass: 'CreateOrEditClientModal',
        });
        ...
        $('#CreateNewQuotationButton').click(function () {
            debugger
            _createOrEditClientsQuotationModal.open();
            // _createOrEditModal.open();
        ...
        $(document).on('click', 'a[data-action60]', function (e) {
            ...
            var rowId = $(this).data('id');
            var action = $(this).data('action60');
            var hiddenfield = $('.ClientId', $(this).closest('tr')).text();
            debugger
            // Handle the selected action based on the rowId..
            if (action === 'edit') {
