(function () {
  $(function () {
    ...
    var _createOrEditModal = new app.ModalManager({
        viewUrl: abp.appPath + 'AppAreaName/Status/CreateOrEditModal',
        scriptUrl: abp.appPath + 'view-resources/Areas/AppAreaName/Views/Status/_CreateOrEditModal.js',
        modalClass: 'CreateOrEditModal',
    });

    var _viewMasterCategoryModal = new app.ModalManager({
        viewUrl: abp.appPath + 'AppAreaName/Status/ViewStatusModal',
