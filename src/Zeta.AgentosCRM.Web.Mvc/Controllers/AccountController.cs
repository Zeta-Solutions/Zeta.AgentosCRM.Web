...
using Zeta.AgentosCRM.Authorization.Impersonation;
...
using Zeta.AgentosCRM.Web.Models.Account;
using Zeta.AgentosCRM.Security;
using Zeta.AgentosCRM.Security.Recaptcha;
using Zeta.AgentosCRM.Sessions;
using Zeta.AgentosCRM.Url;
using Zeta.AgentosCRM.Web.Authentication.External;
using Zeta.AgentosCRM.Web.Security.Recaptcha;
using Zeta.AgentosCRM.Web.Session;
using Zeta.AgentosCRM.Web.Views.Shared.Components.TenantChange;
...
{
    public class AccountController : AgentosCRMControllerBase
    {
            ...
            string returnUrlHash = "", string ss = "")
        {
            ...
            if (loginResult.User.ShouldChangePasswordOnNextLogin)
            {
                ...
                var expireDate =
                    Uri.EscapeDataString(Clock.Now.AddHours(1).ToString(AgentosCRMConsts.DateTimeOffsetFormat));
