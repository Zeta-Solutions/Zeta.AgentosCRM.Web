...
using Zeta.AgentosCRM.Web.HealthCheck;
using Owl.reCAPTCHA;
using Microsoft.AspNetCore.Server.Kestrel.Https;
using Microsoft.Extensions.DependencyInjection.Extensions;
using Zeta.AgentosCRM.Web.Extensions;
using Zeta.AgentosCRM.Web.MultiTenancy;
using SecurityStampValidatorCallback = Zeta.AgentosCRM.Identity.SecurityStampValidatorCallback;
...
namespace Zeta.AgentosCRM.Web.Startup
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            return services.AddAbp<AgentosCRMWebMvcModule>(options =>
            {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            if (env.IsDevelopment())
            {
                ...
                app.UseAgentosCRMForwardedHeaders();
            }
            else
            {
            ...
            if (AgentosCRMConsts.PreventNotExistingTenantSubdomains)
            {
            ...
            if (WebConsts.SwaggerUiEnabled)
            {
                ...
                {
                    options.SwaggerEndpoint(_appConfiguration["App:SwaggerEndPoint"], "AgentosCRM API V1");
                    options.IndexStream = () => Assembly.GetExecutingAssembly()
                        .GetManifestResourceStream("Zeta.AgentosCRM.Web.wwwroot.swagger.ui.index.html");
        ...
        private void ConfigureSwagger(IServiceCollection services)
        {
            ...
            {
                options.SwaggerDoc("v1", new OpenApiInfo() {Title = "AgentosCRM API", Version = "v1"});
                ...
                var applicationXml = $"Zeta.AgentosCRM.Application.xml";
                var applicationXmlPath = Path.Combine(AppContext.BaseDirectory, applicationXml);
                options.IncludeXmlComments(applicationXmlPath);

                var webCoreXmlFile = $"Zeta.AgentosCRM.Web.Core.xml";
