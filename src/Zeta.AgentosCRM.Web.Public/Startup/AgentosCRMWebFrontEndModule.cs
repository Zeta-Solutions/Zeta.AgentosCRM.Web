...
namespace Zeta.AgentosCRM.Web.Public.Startup
{
    [DependsOn(
        typeof(AgentosCRMWebCoreModule)
    )]
    public class AgentosCRMWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public AgentosCRMWebFrontEndModule(IWebHostEnvironment env, AgentosCRMEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(AgentosCRMWebFrontEndModule).GetAssembly());
        }
    }
}
