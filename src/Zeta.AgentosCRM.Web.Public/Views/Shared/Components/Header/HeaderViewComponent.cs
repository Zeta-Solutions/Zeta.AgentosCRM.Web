...
using Zeta.AgentosCRM.Web.Public.Startup;
using Zeta.AgentosCRM.Web.Session;
using Zeta.AgentosCRM.Web.UiCustomization;

namespace Zeta.AgentosCRM.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : AgentosCRMViewComponent
    {
