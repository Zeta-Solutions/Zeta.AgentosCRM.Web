namespace Zeta.AgentosCRM.Authorization
{
    ...
    public static class AppPermissions
    {
        ...
        public const string Pages_ProductBranches_Delete = "Pages.ProductBranches.Delete";

        public const string Pages_ProductFeeDetails = "Pages.ProductFeeDetails";
        public const string Pages_ProductFeeDetails_Create = "Pages.ProductFeeDetails.Create";
        public const string Pages_ProductFeeDetails_Edit = "Pages.ProductFeeDetails.Edit";
        public const string Pages_ProductFeeDetails_Delete = "Pages.ProductFeeDetails.Delete";
        ...
        public const string Pages_PromotionProducts_Delete = "Pages.PromotionProducts.Delete";

        public const string Pages_TaskFollowers = "Pages.TaskFollowers";
        public const string Pages_TaskFollowers_Create = "Pages.TaskFollowers.Create";
        public const string Pages_TaskFollowers_Edit = "Pages.TaskFollowers.Edit";
        public const string Pages_TaskFollowers_Delete = "Pages.TaskFollowers.Delete";
