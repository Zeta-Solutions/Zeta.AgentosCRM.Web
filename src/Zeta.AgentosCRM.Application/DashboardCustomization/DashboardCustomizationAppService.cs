...
namespace Zeta.AgentosCRM.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : AgentosCRMAppServiceBase, IDashboardCustomizationAppService
    {
