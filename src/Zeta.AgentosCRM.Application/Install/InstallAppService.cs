...
using Zeta.AgentosCRM.Migrations.Seed.Host;
...
namespace Zeta.AgentosCRM.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : AgentosCRMAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<AgentosCRMDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{AgentosCRMConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{AgentosCRMConsts.ConnectionStringName}", constring);
        }
