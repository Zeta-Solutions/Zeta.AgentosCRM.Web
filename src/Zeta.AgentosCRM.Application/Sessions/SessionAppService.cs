...
{
    public class SessionAppService : AgentosCRMAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = AgentosCRMConsts.Currency,
                        CurrencySign = AgentosCRMConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = AgentosCRMConsts.AllowTenantsToChangeEmailSettings,
