...
using Zeta.AgentosCRM.Authorization.Users.Profile.Cache;
...
{
    [AbpAuthorize]
    public class ProfileAppService : AgentosCRMAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("Zeta.AgentosCRM",
