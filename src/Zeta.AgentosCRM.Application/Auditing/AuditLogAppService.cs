...
using Zeta.AgentosCRM.Auditing.Exporting;
using Zeta.AgentosCRM.Authorization;
using Zeta.AgentosCRM.Authorization.Users;
using Zeta.AgentosCRM.Dto;
using Zeta.AgentosCRM.EntityHistory;
using EntityHistoryHelper = Zeta.AgentosCRM.EntityHistory.EntityHistoryHelper;

namespace Zeta.AgentosCRM.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : AgentosCRMAppServiceBase, IAuditLogAppService
    {
