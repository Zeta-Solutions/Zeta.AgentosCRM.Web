...
using Zeta.AgentosCRM.Web.Startup.ExternalLoginInfoProviders;
...
namespace Zeta.AgentosCRM.Web.Startup
{
    ...
    public class AgentosCRMWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public AgentosCRMWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(AgentosCRMWebHostModule).GetAssembly());
        }
