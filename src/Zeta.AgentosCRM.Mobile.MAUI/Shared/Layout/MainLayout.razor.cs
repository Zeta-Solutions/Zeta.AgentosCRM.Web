...
using Zeta.AgentosCRM.Services.Navigation;
using Microsoft.AspNetCore.Components;
using Zeta.AgentosCRM.Mobile.MAUI.Services.Account;
using Zeta.AgentosCRM.Mobile.MAUI.Services.UI;
using Microsoft.JSInterop;
using Zeta.AgentosCRM.Mobile.MAUI.Services.Tenants;

#if ANDROID
using Zeta.AgentosCRM.Mobile.MAUI.Platforms.Android.HttpClient;
#endif

namespace Zeta.AgentosCRM.Mobile.MAUI.Shared.Layout
{
...
#elif IOS
            var abpHttpClientFactory = new Zeta.AgentosCRM.Mobile.MAUI.Platforms.iOS.iOSHttpClientFactory
            {
                OnSessionTimeOut = App.OnSessionTimeout,
                OnAccessTokenRefresh = App.OnAccessTokenRefresh
            };
