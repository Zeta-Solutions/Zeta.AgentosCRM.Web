...
using Zeta.AgentosCRM.Common;
using Zeta.AgentosCRM.Core.Dependency;
using Zeta.AgentosCRM.Core.Threading;
using Zeta.AgentosCRM.Editions.Dto;
using Zeta.AgentosCRM.Mobile.MAUI.Extensions;
using Zeta.AgentosCRM.Mobile.MAUI.Models.Tenants;
...
namespace Zeta.AgentosCRM.Mobile.MAUI.Pages.Tenant
{
