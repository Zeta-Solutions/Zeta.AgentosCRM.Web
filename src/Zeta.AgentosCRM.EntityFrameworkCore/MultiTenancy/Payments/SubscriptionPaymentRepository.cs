...
{
    public class SubscriptionPaymentRepository : AgentosCRMRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<AgentosCRMDbContext> dbContextProvider)
