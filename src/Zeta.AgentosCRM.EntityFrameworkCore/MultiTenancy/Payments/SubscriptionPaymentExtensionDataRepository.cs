...
{
    public class SubscriptionPaymentExtensionDataRepository : AgentosCRMRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<AgentosCRMDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
