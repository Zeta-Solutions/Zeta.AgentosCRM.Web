...
namespace Zeta.AgentosCRM.Migrations.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = AgentosCRMConsts.MultiTenancyEnabled ? null : (int?)1;
        ...
        public DefaultLanguagesCreator(AgentosCRMDbContext context)
        {
            _context = context;
        }
