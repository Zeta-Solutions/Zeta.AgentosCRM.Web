...
{
    /// <inheritdoc />
    public partial class Added_PartnerType : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PartnerTypes_MasterCategories_MasterCategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PartnerTypes_MasterCategoryId",
                table: "PartnerTypes",
                column: "MasterCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_PartnerTypes_TenantId",
                table: "PartnerTypes",
                column: "TenantId");
        }
