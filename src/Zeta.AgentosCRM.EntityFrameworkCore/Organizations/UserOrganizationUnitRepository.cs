...
namespace Zeta.AgentosCRM.Organizations
{
    public class UserOrganizationUnitRepository : AgentosCRMRepositoryBase<UserOrganizationUnit, long>,
        IUserOrganizationUnitRepository
    {
        public UserOrganizationUnitRepository(IDbContextProvider<AgentosCRMDbContext> dbContextProvider)
