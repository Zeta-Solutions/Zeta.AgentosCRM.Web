...
using Zeta.AgentosCRM.Authorization.Ldap;
...
using Zeta.AgentosCRM.DashboardCustomization.Definitions;
using Zeta.AgentosCRM.Debugging;
...
using Zeta.AgentosCRM.Localization;
using Zeta.AgentosCRM.MultiTenancy;
using Zeta.AgentosCRM.Net.Emailing;
...
{
    [DependsOn(
        typeof(AgentosCRMCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class AgentosCRMCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            AgentosCRMLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = AgentosCRMConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, AgentosCRMMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<AgentosCRMSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(AgentosCRMCoreModule).GetAssembly());
        }
