...
{
    public class AgentosCRMMailKitSmtpBuilder : DefaultMailKitSmtpBuilder
    {
        private readonly ILocalizationManager _localizationManager;
        private readonly IEmailSettingsChecker _emailSettingsChecker;
        
        public AgentosCRMMailKitSmtpBuilder(
        ...
        {
            return _localizationManager.GetString(AgentosCRMConsts.LocalizationSourceName, name);
        }
    }
}