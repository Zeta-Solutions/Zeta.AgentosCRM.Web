...
namespace Zeta.AgentosCRM.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : AgentosCRMServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Zeta.AgentosCRM", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
