...
{
    public class StripeGatewayManager : AgentosCRMServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "AgentosCRM";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + AgentosCRMConsts.Currency;
        }
